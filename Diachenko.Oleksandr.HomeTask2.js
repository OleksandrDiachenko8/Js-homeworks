...
let region = 'Africa';
console.log(region + "'s countries:");
...
for ( i = 0; i < countries.length; i++) {
    if (capital == countries[i].capital) {
        console.log(capital, 'is the capital of', countries[i].name);
        break;
    }
}
...
for (i = 0; i < countries.length; i++) {
    console.log(`The capital of ${countries[i].name} is ${countries[i].capital}.The current population is ${countries[i].population}.`);
}

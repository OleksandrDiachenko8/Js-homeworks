...
// 1. Вивести в index.html кожну країну у форматі:
...
function infoContainerCreate(propertyName, property) {
    const infoContainer = document.createElement('div');
    infoContainer.className = 'country-info';
    infoContainer.innerHTML = '<span>' + propertyName + '</span><span>' + property + '</span>';
...
for (let i = 0; i < countries.length; i++) {
    ...
    countryNameTitle.innerText = countries[i].name;
    countryContainer.appendChild(countryNameTitle);

    countryContainer.appendChild(infoContainerCreate('Capital: ', countries[i].capital));
    countryContainer.appendChild(infoContainerCreate('Population: ', countries[i].population));
